...
def parse_args(script):
    ...
    if script == 'train':
        ...
        parser.add_argument('--eval_interval', default=20, type=int, help="Eval interval")
        ...
        parser.add_argument('--devices'      ,  default=None, help='GPU id') # If multiple and --parallel=True, give gpus with commas - eg. "0,1"
